...
- Keep `examples/concerns/example_preinitialization`.  
...
- Besides the assistant answer, check the **first turn** for extra weave related to the concern (log `weave @preinitialization`).  
- Wording should skew **conservative, auditable, assume worst-case failure** (aligned with the concern body).
...
**Observe**  
The **NL clause** of `example_preinitialization` should not hold — do not expect this concern to fire for a non-prod demo.
