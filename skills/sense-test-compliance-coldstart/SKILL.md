...
- Keep `examples/senses/example_staticinitialization` (`any_of`: **audit**, **compliance**).  
- Like `sense-test-prod-coldstart`: needs the **first prompt after a process-level cold start** to satisfy the NL clause.
...
- Should stress **scope, basis, retention, reviewable phrasing** (aligned with the sense).  
...
**Observe**  
The NL condition for this sense should not fire.
